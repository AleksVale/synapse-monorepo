...
export interface ListProductsResponseDto extends ApiResponse<ProductListItemDto[]> {
    pagination: {
        page: number;
        limit: number;
        total: number;
...
export interface ListIntegrationsResponseDto extends ApiResponse<IntegrationListItemDto[]> {
    pagination?: {
        page: number;
        limit: number;
        total: number;
...
export declare const API_ENDPOINTS: {
    ...
    readonly PRODUCTS: {
        ...
        readonly BY_ID: (id: number) => string;
        readonly BY_USER: (userId: number) => string;
    };
    readonly INTEGRATIONS: {
        readonly BASE: "/integrations";
        readonly BY_ID: (id: number) => string;
        readonly BY_USER: (userId: number) => string;
        readonly SYNC: (id: number) => string;
    };
    readonly CAMPAIGNS: {
        readonly BASE: "/campaigns";
        readonly BY_ID: (id: number) => string;
        readonly BY_PRODUCT: (productId: number) => string;
        readonly ANALYTICS: (id: number) => string;
    };
    readonly METRICS: {
        readonly BASE: "/metrics";
        readonly BY_ID: (id: number) => string;
        readonly BY_CAMPAIGN: (campaignId: number) => string;
    };
    readonly SALES: {
        readonly BASE: "/sales";
        readonly BY_ID: (id: number) => string;
        readonly BY_PRODUCT: (productId: number) => string;
        readonly ANALYTICS: (productId: number) => string;
    };
    readonly AUDIT_LOGS: {
        readonly BASE: "/audit-logs";
        readonly BY_USER: (userId: number) => string;
    };
    readonly WEBHOOKS: {
        readonly KIWIFY: "/webhooks/kiwify";
        readonly EDUZZ: "/webhooks/eduzz";
        readonly HOTMART: "/webhooks/hotmart";
    };
};
